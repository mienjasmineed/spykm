...
<div class="wrapper" style="background-color:#009973" id="app"> 
  ...
  <header class="main-header" style="background-color:#009973" >
    <!-- Logo -->
    <a href="<?php echo e(route('admin.home')); ?>" class="logo" style="background-color:#009973">
    ...
    <nav class="navbar navbar-static-top" style="background-color:#009973">
      ...
      <div class="navbar-custom-menu" >
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo e(route('admin.login')); ?>"><?php echo e(ucfirst(config('multiauth.prefix'))); ?> Login</a></li>
            <?php else: ?>
            <li class="dropdown">
    ...
    <section class="sidebar" style="background-color:#051405">
      ...
      <div class="user-panel" >
        ...
        <div class="pull-left info">
          <p><?php if(Auth:: check() && Auth::user()->name): ?><?php echo e(Auth::user()->name); ?></p><?php endif; ?>
