...
<!-- Site wrapper -->
<div class="wrapper" style="background-color:#009973"> 

  <header class="main-header" style="background-color:#009973" >
    <!-- Logo -->
    <a href="../../index2.html" class="logo" style="background-color:#009973">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="background-color:#051405">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="../widgets.html">
            <i class="fa fa-th"></i> <span>Maklumat Murid</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Kehadiran</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Semak Kehadiran</a></li>
           <!-- <li class="treeview">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Muat Naik Dokumen</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
