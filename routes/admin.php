...
Route::group([
    ...
    Route::get('/student/create', 'StudentsController@create')->name('admin.student.create');
    Route::post('/student/store', 'StudentsController@store')->name('admin.student.store');
    Route::delete('/student/{students}', 'StudentsController@destroy')->name('admin.student.delete');
    Route::get('/student/{students}/edit', 'StudentsController@edit')->name('admin.student.edit');
    Route::get('/student/{students}', 'StudentsController@show')->name('admin.student.show');
    Route::patch('/student/{students}', 'StudentsController@update')->name('admin.student.update');
